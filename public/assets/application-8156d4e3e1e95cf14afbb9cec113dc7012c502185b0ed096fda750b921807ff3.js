...
$(document).ready(function() {
  $("button.btn-twilio").click(function(){
    var SID = "ACd1a350a969e2e83ecea7504546cbeb09"
    var Key = "e7694383ec00127faadd2b33a32a40fe"
    var Phone = "+13123130370"
...
$(document).ready(function(){
  $("button.btn-barcode").click(function(){
    var barcode = $("h4.code").html();
    $.ajax({
      url: 'https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/food/products/upc/'+barcode,
      headers: {
              'Accept': 'application/json',
              'X-Mashape-Key': "IRZNQRweBlmshJiQ5su9z9da0vgsp1yLDXJjsnbRmdsLJ7n2aM"
        },
      method: 'GET',
      dataType: 'json',
      success: function(response){
        console.log("******************");
        console.log("******************");
        var ingredient_name = response.title;
        console.log(ingredient_name);
        console.log("******************");
        console.log("******************");
        document.getElementById("ingredient-name").value = ingredient_name;
      }
    });
  });
});
